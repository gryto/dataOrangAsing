import 'dart:convert';
import 'package:data_orang_asing/screen/camera/page.dart';
import 'package:data_orang_asing/screen/dataKtp/page.dart';
import 'package:data_orang_asing/screen/face/page.dart';
...
class _MainTabBarState extends State<MainTabBar> {
          ...
          Row(
            children: [
              CircleAvatar(
                ...
                child: CircleAvatar(
                  radius: 28,
                  backgroundImage: NetworkImage('${ApiService.folder}/$path'),
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              extraWidget("notification", "Kamera FR", true, 1),
                              extraWidget("help", "Data KTP", false, 2),
                              extraWidget("user", "Menu 3", true, 3),
                            ],
                          ),
                          const SizedBox(
                            height: 20,
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                              extraWidget("activity", "Menu 4", false, 4),
                              extraWidget("report", "Menu 5", true, 5),
                              extraWidget("document", "Menu 6", true, 6),
                            ],
                          ),
                        ],
                      ),
  ...
  GestureDetector extraWidget(
      String img, String name, bool isSelected, int inx) {
    return GestureDetector(
      onTap: () {
        if (inx == 1) {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const MonitoryPage(),
            ),
          );
        } else if (inx == 4) {
          Navigator.of(context).push(
